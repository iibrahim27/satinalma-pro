package com.satinalmayonetici.android.services
...
class ApkUpdateInstaller(private val context: Context) {
    ...
    fun install(apkFile: File) {
        ...
        if (!ensureInstallPermission()) throw IllegalStateException("Kurulum izni gerekli — izin verdikten sonra tekrar deneyin")
