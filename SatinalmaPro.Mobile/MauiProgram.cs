...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        // Yönetim Paneli (UI — mock veri)
        builder.Services.AddTransient<YonetimAnaSayfaViewModel>();
        builder.Services.AddTransient<YonetimTaleplerViewModel>();
        builder.Services.AddTransient<YonetimTalepDetayViewModel>();
        builder.Services.AddTransient<YonetimTekliflerViewModel>();
        builder.Services.AddTransient<YonetimTeklifDetayViewModel>();
        builder.Services.AddTransient<YonetimBildirimlerViewModel>();
        builder.Services.AddTransient<YonetimProfilViewModel>();
        builder.Services.AddTransient<YonetimAnaSayfaPage>();
        builder.Services.AddTransient<YonetimTaleplerPage>();
        builder.Services.AddTransient<YonetimTalepDetayPage>();
        builder.Services.AddTransient<YonetimTekliflerPage>();
        builder.Services.AddTransient<YonetimTeklifDetayPage>();
        builder.Services.AddTransient<YonetimBildirimlerPage>();
        builder.Services.AddTransient<YonetimProfilPage>();
