...
public partial class YonetimTekliflerPage : ContentPage
{
    private readonly YonetimTekliflerViewModel _vm;

    public YonetimTekliflerPage(YonetimTekliflerViewModel vm)
    {
        InitializeComponent();
        _vm = vm;
        BindingContext = vm;
