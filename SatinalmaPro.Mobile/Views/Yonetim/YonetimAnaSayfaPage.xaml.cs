...
public partial class YonetimAnaSayfaPage : ContentPage
{
    private readonly YonetimAnaSayfaViewModel _vm;

    public YonetimAnaSayfaPage(YonetimAnaSayfaViewModel vm)
    {
        InitializeComponent();
        _vm = vm;
        BindingContext = vm;
