...
public partial class GecmisTeklifliOnaylarPage : ContentPage
{
    private readonly OturumServisi _oturum;

    public GecmisTeklifliOnaylarPage(OturumServisi oturum)
    {
        InitializeComponent();
        _oturum = oturum;
    ...
    {
        base.OnAppearing();
        if (!await MobilSayfaKorumasi.RotaErisimAsync(this, _oturum, "gecmis-teklifli-onaylar"))
            return;
    ...
    private async Task YukleAsync()
    {
        ...
        Liste.ItemsSource = _oturum.Satinalma.YonetimGecmisTeklifliOnaylari()
