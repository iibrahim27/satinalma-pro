...
public partial class GecmisTaleplerPage : ContentPage
{
    private readonly OturumServisi _oturum;

    public GecmisTaleplerPage(OturumServisi oturum)
    {
        InitializeComponent();
        _oturum = oturum;
    ...
    {
        base.OnAppearing();
        if (!await MobilSayfaKorumasi.RotaErisimAsync(this, _oturum, "gecmis-talepler"))
            return;
    ...
    private async Task YukleAsync()
    {
        ...
        Liste.ItemsSource = _oturum.Satinalma.YonetimGecmisTalepleri()
