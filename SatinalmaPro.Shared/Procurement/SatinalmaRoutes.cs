...
/// <summary>
/// Masaüstü ve Android satınalma modülü route slug'ları — <c>SatinalmaPart1Menusu</c> ile birebir.
/// </summary>
public static class SatinalmaRoutes
{
    public const string Panosu = "satinalma-panosu";
    public const string TalepForm = "satinalma-talep";
    public const string Taleplerim = "satinalma-talepler";
    public const string OnayBekleyen = "satinalma-onay-bekleyen";
    public const string OnaylananTaleplerSaha = "satinalma-onaylanan-talepler";
...
public static class StokRoutes
{
    ...
    public const string StokSayim = "Stok Sayım";
}
